...
namespace AppointmentHospital.Areas.Admin.Repositories
{
    ...
    {
        Task<Dictionary<string, int>> GetAmountAppointment(DateTime? singleDate, Dictionary<int, List<DateTime>> startAndLastDay);
        Task<Dictionary<string, List<int>>> GetOldAndNewUser(DateTime? singleDate, Dictionary<int, List<DateTime>> startAndLastDay);
        ...
        Task<Dictionary<string, List<TopDoctorStatistic>>> GetTopDoctorAppointment(DateTime? singleDate, Dictionary<int, List<DateTime>> startAndLastDay);
    }
}
